...
# lsd (guard — only alias if installed)
command -v lsd &>/dev/null && alias l='lsd -la' && alias lt='lsd --tree'
#---------------------------------------------------------------
# History
#---------------------------------------------------------------
setopt HIST_IGNORE_SPACE # Don’t save lines which begin with a <space> character
setopt HIST_IGNORE_DUPS # Eliminate duplicates
...
# Setting HISTSIZE and SAVEHIST to -1 causes the history list to be unlimited 
export HISTSIZE=-1
export SAVEHIST=-1
...
#---------------------------------------------------------------
#  Zsh completion system is initialized correctly
#---------------------------------------------------------------
